...
function Process-Run {
    ...
    $log = Join-Path $logDir "$($Id)_post_gpu0.log"
...
Process-Run "p2_value_only" "configs\qwen3vl_instruction\next_stage\p2_value_only.yaml" "configs\qwen3vl_instruction\next_stage_lp\lp_p2_value_only_chexpert_1k.yaml"
Process-Run "storymix_qa8" "configs\qwen3vl_instruction\next_stage\storymix_qa8.yaml" "configs\qwen3vl_instruction\next_stage_lp\lp_storymix_qa8_chexpert_1k.yaml" -AbSwapVal "outputs\instruction_data\next_stage\storymix_qa8_val_ab_swap.jsonl" -HardShuffle
Process-Run "cf_heavy_qa8" "configs\qwen3vl_instruction\next_stage\cf_heavy_qa8.yaml" "configs\qwen3vl_instruction\next_stage_lp\lp_cf_heavy_qa8_chexpert_1k.yaml" -AbSwapVal "outputs\instruction_data\next_stage\cf_heavy_qa8_val_ab_swap.jsonl" -HardShuffle
Process-Run "sameq_shuf_3k" "configs\qwen3vl_instruction\next_stage\sameq_shuf_3k.yaml" "configs\qwen3vl_instruction\next_stage_lp\lp_sameq_shuf_3k_chexpert_1k.yaml" -AbSwapVal "outputs\instruction_data\next_stage\sameq_shuf_val_ab_swap.jsonl" -HardShuffle
