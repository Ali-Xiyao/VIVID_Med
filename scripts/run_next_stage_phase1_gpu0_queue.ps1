...
$runs = @(
    @{
        Id = "P2-value-only"
        Config = "configs\qwen3vl_instruction\next_stage\p2_value_only.yaml"
        OutputDir = "outputs\qwen3vl_instruction\next_stage\p2_value_only"
    },
    @{
        Id = "StoryMix-QA8"
        Config = "configs\qwen3vl_instruction\next_stage\storymix_qa8.yaml"
        OutputDir = "outputs\qwen3vl_instruction\next_stage\storymix_qa8"
    },
    @{
        Id = "CF-heavy-QA8"
        Config = "configs\qwen3vl_instruction\next_stage\cf_heavy_qa8.yaml"
        OutputDir = "outputs\qwen3vl_instruction\next_stage\cf_heavy_qa8"
    },
    @{
        Id = "SAMEQ-SHUF-3k"
        Config = "configs\qwen3vl_instruction\next_stage\sameq_shuf_3k.yaml"
        OutputDir = "outputs\qwen3vl_instruction\next_stage\sameq_shuf_3k"
    }
)
