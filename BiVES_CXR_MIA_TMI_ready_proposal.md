...
3. uncertain 与 insufficient 经过人工审阅后具有可接受的一致性；
...
临床陈述由冻结的轻量文本编码器或 canonical statement embedding 得到：
...
| Run ID | 内容 | 输出 | Gate |
|---|---|---|---|
| P0-1 | 报告解析抽样审计 | 各字段 precision/recall | 显式正负达到高可靠性 |
| P0-2 | U/I 双盲标注 pilot | agreement、混淆 | 定义可被专家稳定区分 |
