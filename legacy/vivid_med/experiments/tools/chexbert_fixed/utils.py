...
try:
    ...
    # statsmodels removed statsmodels.stats.inter_rater.cohens_kappa after ~0.9.
    # cohens_kappa is only used for training-time kappa reporting, never for
    # inference. Guard the import so label.py / smoke-test can run offline.
    cohens_kappa = None
