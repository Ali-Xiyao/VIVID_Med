...
| C6 MS-CXR official-test metadata-only intake | `bives_cxr_c6_ms_cxr_intake.md`, `../scripts/audit_bives_c6_ms_cxr.py`, `../bives_cxr/c6_ms_cxr.py`, `../refine-logs/C6C_MS_CXR_INTAKE_TOOLING_LOG_20260718.md`, `../refine-logs/C6D_MS_CXR_REAL_PACKAGE_PREFLIGHT_LOG_20260718.md` |
